...
export default function NotesPage() {
  ...
  const renderBlock = (block: NoteBlock) => {
    switch (block.type) {
      ...
      case 'quote':
        return (
          <blockquote className="border-l-4 border-blue-400 pl-4 py-2 my-2 bg-blue-50 dark:bg-blue-900/20 rounded-r-lg italic">
            {block.content}
          </blockquote>
        );
      case 'code':
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex">
      {/* Sidebar - Notes List */}
      <div className="w-96 bg-white dark:bg-gray-800 border-r dark:border-gray-700 flex flex-col h-screen">
        {/* Header */}
        <div className="p-4 border-b dark:border-gray-700">
          ...
          <div className="relative mb-3">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900/50 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="flex-1 px-3 py-1.5 text-sm border dark:border-gray-700 rounded-lg dark:bg-gray-800 dark:text-gray-100"
            >
            ...
            <button
              ...
              className={`p-2 border dark:border-gray-700 rounded-lg ${showPinnedOnly ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-300 dark:border-blue-800' : ''}`}
            >
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        {selectedNote ? (
              ...
              <div className="flex-1">
                {isEditing ? (
                  <input
                    ...
                    className="text-xl font-bold w-full border-b-2 border-blue-300 dark:border-blue-500 focus:outline-none pb-1 dark:bg-gray-800 dark:text-gray-100"
                    autoFocus
                  />
                ) : (
                ...
                {isEditing ? (
                  <>
                    <button
                      ...
                      className="px-3 py-1.5 text-sm border dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700"
                    >
                      Cancel
                    </button>
                    <button
              ...
              <div className="max-w-3xl mx-auto">
                ...
                {isEditing ? (
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900/50 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500"
                    />
                  </div>
                ...
                {isEditing ? (
                  <textarea
                    ...
                    className="w-full min-h-[400px] p-4 border dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900/50 resize-none font-mono text-sm dark:bg-gray-800 dark:text-gray-100"
                ...
                {/* Metadata */}
                {!isEditing && (
                  <div className="mt-8 pt-4 border-t dark:border-gray-700 text-xs text-gray-400 dark:text-gray-500">
                    ...
                    {!selectedNote.is_synced && (
                      <div className="text-yellow-600 dark:text-yellow-500 mt-1">⚠ Stored locally only</div>
                    )}
                  </div>
                )}
              </div>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              <FileText className="w-16 h-16 mx-auto mb-4 text-gray-200 dark:text-gray-600" />
              <h3 className="text-lg font-medium text-gray-600 dark:text-gray-300 mb-2">Select a note</h3>
